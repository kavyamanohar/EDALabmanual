...
%\date{December 2013}
\author{Kavya Manohar \and Second Author} {%Authors: Kavya Manohar} % Add Authors here
\maketitle

-------------------------------------
%\thispagestyle{empty}
  
\noindent \textcopyright{}2016, Authors.\\
\noindent
...
\input{chapters/equationSolve.tex}
\input{chapters/signalplot.tex}
\input{chapters/diodeFBchar.tex}
\input{chapters/fileReadWrite.tex}
